    ...
    request(URL, function (err, response, body) {
                ...
                if(dateText == "12.21.20") {
                    ...
                    function linkInformation(linklocation){
                        ...
                        if (linklocation){
                            ...
                            return 'https://www.appropriations.senate.gov/' + link;
                        }
                    }
        ...
        for( let i =0; i < press_date.length; i++ ){
            ...
            results[i] = {
                ...
                month: month,
                year: year,
                org: 'United States Senate Committee on Appropriations'
            }
        }
...
scrapeItems('https://www.appropriations.senate.gov/news/minority');