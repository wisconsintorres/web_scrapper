...
function scrapeItems (URL){
    ...
    request(URL, function (err, response, body) {
        ...
        let press_link = [];
        const results = [];
        const URLElements = $('div').find('.element-header').find('.span');
        const URLElementsA = $('#press').find('li').find('a');
        //console.log(URLElements[0].text())
        ...
        fs.writeFileSync('senate-commerce-committee-maj.json', data_JSON);

    })
}

scrapeItems('https://www.commerce.senate.gov/pressreleases');